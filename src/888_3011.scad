...
module 888_3011(draft = true){
    difference(){
        ...
        translate([bearing_efsm_12_m/2, bearing_efsm_12_m/2, 0])
        {
            ...
            translate([-M5_nut_diameter/2, -M5_nut_diameter/2, 888_nut_distance])
                cube([M5_nut_diameter, 25, M5_nut_height]);
        }
        ...
        translate([-bearing_efsm_12_m/2, bearing_efsm_12_m/2, 0]){
      		cylinder(h=888_height+1, d=bearing_efsm_12_n, $fn=draft?50:100);
                translate([-M5_nut_diameter/2, -M5_nut_diameter/2, 888_nut_distance]) cube([M5_nut_diameter, 25, M5_nut_height]);
      	}
        ...
        translate([0, podlozka_diry_vzdalenost/2, 10]){
            cylinder(h=888_height+1, d=M4_screw_diameter, $fn=draft?50:100);
                translate([-M4_nut_diameter/2, -M4_nut_diameter/2, 888_height-888_nut_distance-10]) 
                    cube([M4_nut_diameter, 25, M4_nut_height]);
        }
