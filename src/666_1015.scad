...
module 666_1015(draft){
    ...
    difference(){
        ...
        translate ([0,0,- global_clearance/2])
            cylinder(h = height_666_1015 + global_clearance, d = tube_for_undercarriage_outer_diameter, $fn = draft ? 100 : 200);
        ...
        translate([-width_666_1015/2 - global_clearance/2,-(thickness_between_tubes_undercarriage + tube_for_undercarriage_outer_diameter/2 + tube_for_undercarriage_outer_diameter/2), height_666_1015/2])
            rotate([0,90,0])
                cylinder(h = width_666_1015 + global_clearance, d=tube_for_undercarriage_outer_diameter, $fn = draft ? 100 : 200);
        ...
        translate([width_666_1015/2 - M3_nut_height, 0, height_666_1015/4])
    	   rotate([0,90,0])
    	       cylinder (h = M3_nut_height + global_clearance, r = M3_nut_diameter/2, $fn = 6);
        ...
        translate([width_666_1015/2 - M3_nut_height, 0, height_666_1015 - height_666_1015/4])
            rotate([0,90,0])
                cylinder (h = M3_nut_height + global_clearance, r = M3_nut_diameter/2, $fn = 6);
    	...
    	translate([-width_666_1015/4,  -(thickness_between_tubes_undercarriage + tube_for_undercarriage_outer_diameter/2 + tube_for_undercarriage_outer_diameter/2) ,width_666_1015-M3_nut_height])
            cylinder (h = M3_nut_height + global_clearance, r = M3_nut_diameter/2, $fn = 6);
