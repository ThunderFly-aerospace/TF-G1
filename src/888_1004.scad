...
union(){
    difference(){
		...
		//základní kapka
			intersection (){
				drop_skin();
					translate([0, - thickness_between_tubes,- hull_z_size/2])
							cube([hull_drop_length, hull_y_size + thickness_between_tubes, hull_z_size]);
			}
...
//final difference
            ...
            union(){
           	    intersection(){
    				difference(){
    					translate([0,-thickness_between_tubes+global_clearance/2,-hull_z_size/2])		
            		...
            		//for tube in back
                        ...
                        translate([ribbon_width/2,0,0])
                            hollowing_skeleton_hem(ribbon_width, draft);
    				}		
       	...
       	intersection(){
            union(){
                ...
                //přední stěna Z+
       		    //čtverec
				translate([ 0, - thickness_between_tubes + hull_wall_thickness*2, width_of_engine_holder/2 ])		
					cube([top_cover_division[1], hull_y_size, hull_wall_thickness]);

                //přední stěna Z-
       		    //čtverec
				translate([ 0, - thickness_between_tubes + hull_wall_thickness*2, - hull_wall_thickness - width_of_engine_holder/2])		
					cube([top_cover_division[1], hull_y_size, hull_wall_thickness]);
                ...
                difference(){
                    union(){
                        ...
                        difference(){
                            union(){
                            translate([top_cover_division[1],main_tube_outer_diameter/2 + 6*coupling_wall_thickness + global_clearance,-hull_z_size/2])      
...
module 888_1004_part(part_number, draft){ 
                ...
                union(){
                    intersection(){
                        ...
                        union(){
                            ...
                            //čtverec pro zámek Z+
                            translate([previous_division - 2*hull_wall_thickness, main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, main_tube_outer_diameter ])
                                    cube([hull_wall_thickness*3, lock_width, hull_z_size]);
                            //čtverec pro zámek Z-
                            translate([previous_division - 2*hull_wall_thickness, main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, - hull_z_size - main_tube_outer_diameter])
                                    cube([hull_wall_thickness*3, lock_width, hull_z_size]);
                        //union
                        }   
                    //intersection
                ...
                union(){
                    intersection(){
                        ...
                        union(){
                            ...
                            //čtverec pro zámek Z+
                            translate([division_position - 2*hull_wall_thickness,main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness,hull_z_size/2 - main_tube_outer_diameter])
                                cube([hull_wall_thickness*4 + global_clearance, lock_width + global_clearance, hull_z_size]);
                            //čtverec pro zámek Z-
                            translate([division_position - 2*hull_wall_thickness,main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness,- hull_z_size - main_tube_outer_diameter ])
                                cube([hull_wall_thickness*4 + global_clearance, lock_width + global_clearance, hull_z_size]);
                        //union
                        }   
                    //intersection
                ...
                union(){
                    intersection(){
                        ...
                        union(){
                            ...
                            //čtverec pro zámek Z+
                            translate([division_position - 2*hull_wall_thickness, main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, main_tube_outer_diameter])
                                    cube([hull_wall_thickness*4, lock_width, hull_z_size]);
                            //čtverec pro zámek Z-
                            translate([division_position - 2*hull_wall_thickness, main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, -main_tube_outer_diameter - hull_z_size ])
                                    cube([hull_wall_thickness*4, lock_width, hull_z_size]);
                        //union
                        }   
                    //intersection
                    ...
                    intersection(){
                        ...
                        union(){
                            ...
                            translate([previous_division - 2*hull_wall_thickness,main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, main_tube_outer_diameter])
                                cube([hull_wall_thickness*4 + global_clearance, lock_width + global_clearance, hull_z_size]);
                            //čtverec pro zámek Z-
                            translate([previous_division - 2*hull_wall_thickness,main_tube_outer_diameter/2 + coupling_wall_thickness + global_clearance + 3*hull_wall_thickness, - main_tube_outer_diameter - hull_z_size])
                                cube([hull_wall_thickness*4 + global_clearance, lock_width + global_clearance, hull_z_size]);
                        //union
                        }   
                    //intersection
...
888_1004_part(1, draft);

translate([10,0,0])
888_1004_part(2, draft);


translate([20,0,0])
888_1004_part(3, draft);

translate([30,0,0])
888_1004_part(4, draft);

translate([40,0,0])
888_1004_part(5, draft);
