...
module 888_1007_A(draft){
    ...
    difference(){
        ...
        intersection(){
            ...
            translate([bottom_cover_division[1] - 2* hull_wall_thickness, - hull_y_size - main_tube_outer_diameter/2, - hull_z_size/2])
