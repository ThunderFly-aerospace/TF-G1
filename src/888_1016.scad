...
module 888_1016(draft){
    ...
    hall_width = 25;
    hall_thickness = 2;
    holder_length = plate_length + hall_distance - plate_axis_from_end + hall_length/2 + hall_holder_wall_thickness; 
    ...
    difference(){
        ...
        translate([-hall_width/2, plate_length+hall_distance - plate_axis_from_end - hall_length/2, plate_thickness - hall_thickness])
