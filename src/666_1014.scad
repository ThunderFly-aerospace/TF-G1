...
mirror([1,0,0])
   ...
   translate([-(width/2) - global_clearance/2, -depth + height/2-sqrt(2)*coupling_wall_thickness_undercarriage,height/2])  
    ...
    //screw
    translate([-width/2 - global_clearance/2,-(thickness_between_tubes_undercarriage + tube_for_undercarriage_outer_diameter/2 + M4_screw_diameter/2), tube_for_undercarriage_outer_diameter/2 + coupling_wall_thickness_undercarriage])
        rotate([0,90,0])
...
difference(){
    ...
    //nut    
    translate([width/2 - Nut_height_M3,-(thickness_between_tubes_undercarriage + tube_for_undercarriage_outer_diameter/2 + M4_screw_diameter/2), tube_for_undercarriage_outer_diameter/2 + coupling_wall_thickness_undercarriage])
       rotate([0,90,0])
