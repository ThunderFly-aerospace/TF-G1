...
difference () {
    ...
    //middle cut
    translate ([-2,-depth_666_1017/2 - global_clearance/2,- global_clearance/2])
       cube ([4,depth_666_1017 + global_clearance,height_666_1017 + material_plus + global_clearance]);
