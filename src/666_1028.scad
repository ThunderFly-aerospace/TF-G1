        ...
        union(){
            ...
            intersection(){
                ...
                union(){
                    ...
                    //Material for rudder support----------------------------------
                    translate([tail_length - Rudder_length - Rudder_gap_width - Rudder_infill_wall_thickness, - tail_depth / 2, - 1])
                        cube([Rudder_infill_wall_thickness, tail_depth, Rudder_height + 2]);
