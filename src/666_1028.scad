    ...
    difference (){
        ...
        //UPPER - od osy x do minus y
            difference (){
				...
				translate([0,-10,-0.5 + 3*hull_wall_thickness])
					rotate([0,-90,160])
        				//výztuhy
        				difference(){
        					resize([95 - hull_wall_thickness - trailing_wall*hull_wall_thickness,(95*0005/100) - 2*hull_wall_thickness, 152 - hull_wall_thickness], auto=true) 
                          //      resize([hull_drop_length - shell_thickness - trailing_wall*     , (hull_drop_length*hull_airfoil_thickness/100) - 2*shell_thickness, (hull_drop_length*hull_airfoil_thickness/100) - 2*shell_thickness], auto=true)
        ...
        //VERTICAL
            difference (){
                ...
                //dutý profil
                translate([140,75 - hull_wall_thickness, -0.5 + 3 * hull_wall_thickness])
                    rotate([90,-87,0])
                        //výztuhy
                      	difference(){
                        	resize([150 - hull_wall_thickness - trailing_wall*hull_wall_thickness,((150-2*hull_wall_thickness)*0005/100)- 2*hull_wall_thickness, 150 - 2*hull_wall_thickness], auto=true) 
                            	airfoil(naca = 0005, L = 150 , N = draft ? 50 : 100, h = 150 , open = false);
