...
rimHeight      = 8;        // The height of the rim portion of the wheel. 
...
numberOfSpokes    = 15;          // Number of "spokes." Set this to three if you're doing the biohazard design
...
hubDiameter          = 10;    // The diameter of the hub portion of the wheel
...
innerCircleDiameter  = 20;    // The diameter of the solid inner circle under the hub, or zero for none. 
...
shaftDiameter        = 3.2;          // The diameter of the motor shaft
shaftFlatDiameter    = 3.2;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
